...
contract RandomIpfsNft is ERC721URIStorage, VRFConsumerBaseV2, Ownable {
    ...
    constructor(
        ...
        i_gasLane = gasLane;
        i_subscriptionId = subscriptionId; // Now storing as uint256
        i_mintFee = mintFee;
    ...
    function requestNft() public payable returns (uint256 requestId) {
        ...
        // Cast the subscriptionId to uint64 when calling requestRandomWords
        requestId = i_vrfCoordinator.requestRandomWords(
            i_gasLane,
            uint64(i_subscriptionId), // Cast to uint64
